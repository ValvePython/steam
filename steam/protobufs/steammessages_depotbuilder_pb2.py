...
_CONTENTBUILDER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030/Start uploading manifest and chunks for a depot')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030+Get list of missing chunks for depot upload')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030?Commit a depot build after manifest and all chunks are uploaded')),
  ),
  _descriptor.MethodDescriptor(
    name='CommitAppBuild',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030>Combine previous depot uploads into an app build and commit it')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030\026Sign an install script')),
  ),
])
