...
_CCREDENTIALS_GETSTEAMGUARDDETAILS_REQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030FWhether or not to populate the newauthentication field in the response'))),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030}The user\'s Steam Guard machine auth cookie. If present, it\'ll be used to get the user\'s machine ID instead of the AM session.'))),
    _descriptor.FieldDescriptor(
...
_CCREDENTIALS_GETSTEAMGUARDDETAILS_REQUEST.fields_by_name['include_new_authentications']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030FWhether or not to populate the newauthentication field in the response'))
_CCREDENTIALS_GETSTEAMGUARDDETAILS_REQUEST.fields_by_name['webcookie'].has_options = True
_CCREDENTIALS_GETSTEAMGUARDDETAILS_REQUEST.fields_by_name['webcookie']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030}The user\'s Steam Guard machine auth cookie. If present, it\'ll be used to get the user\'s machine ID instead of the AM session.'))
...
_CREDENTIALS = _descriptor.ServiceDescriptor(
  ...
  file=DESCRIPTOR,
  index=0,
  options=_descriptor._ParseOptions(descriptor_pb2.ServiceOptions(), _b('\202\265\030\023Credentials service')),
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030\025GetSteamGuardDetails.')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030#NewMachineNotificationDialogResult.')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030\'Validate an email address given a token')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030\030SteamGuardPhishingReport')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030\037GetCredentialChangeTimeDetails.')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030\024GetAccountAuthSecret')),
  ),
])
