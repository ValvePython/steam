...
_PLAYER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030GGet a list of friends who are playing, have played, own, or want a game')),
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\0305Gets a list of the emoticons a user has with metadata')),
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030\035Get current privacy settings.')),
  ),
])
...
_PLAYERCLIENT = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=steammessages__unified__base__pb2._NORESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\0306Notification from server that privacy settings changed')),
  ),
])
