...
_PARTNERAPPS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=_CPARTNERAPPS_REQUESTUPLOADTOKEN_REQUEST,
    output_type=_CPARTNERAPPS_REQUESTUPLOADTOKEN_RESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030<Request upload token for executable file upload / processing')),
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030BCommit method to sign an installscript after an upload is complete')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030,Commit method for executable file processing')),
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030*Finds N most recent prior uploads by appid')),
  ),
  _descriptor.MethodDescriptor(
    name='Download',
