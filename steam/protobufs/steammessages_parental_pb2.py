...
_PARENTAL = _descriptor.ServiceDescriptor(
  ...
  file=DESCRIPTOR,
  index=0,
  options=_descriptor._ParseOptions(descriptor_pb2.ServiceOptions(), _b('\202\265\030\031Parental settings service')),
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030[Enable parental settings for the logged in account, optionally setting the current settings')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\0303Disable parental settings for the logged in account')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030;Get the current parental settings for the logged in account')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030jGet the current parental settings for the logged in account in a form that can by verified by the receiver')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030;Set the current parental settings for the logged in account')),
  ),
  _descriptor.MethodDescriptor(
    name='ValidateToken',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030MCheck if the given parental unlock token is correct for the logged in account')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030TValidate the plaintext password for the logged in account and return an unlock token')),
  ),
  _descriptor.MethodDescriptor(
    name='LockClient',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030>Notify connected clients that a lock has occurred in a browser')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030WRequest a recovery code be sent to the recovery email address for the specified account')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\0302Attempt a recovery unlock on the specified account')),
  ),
])
...
_PARENTALCLIENT = _descriptor.ServiceDescriptor(
  ...
  file=DESCRIPTOR,
  index=1,
  options=_descriptor._ParseOptions(descriptor_pb2.ServiceOptions(), _b('\202\265\030&Parental settings client notifications\300\265\030\002')),
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030CNotification from server to client of a change in parental settings')),
  ),
  _descriptor.MethodDescriptor(
    name='NotifyUnlock',
    ...
    output_type=steammessages__unified__base__pb2._NORESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030KNotification from server to client that an unlock has occurred in a browser')),
  ),
  _descriptor.MethodDescriptor(
    name='NotifyLock',
    ...
    output_type=steammessages__unified__base__pb2._NORESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030HNotification from server to client that a lock has occurred in a browser')),
  ),
])
