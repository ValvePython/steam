...
_CFRIENDMESSAGES_GETRECENTMESSAGES_REQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\0309If non-zero, cap the number of recent messages to return.'))),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030MGrab the block of chat from the most recent conversation (a ~5 minute period)'))),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030\207\001If non-zero, return only messages with timestamps greater or equal to this. If zero, we only return messages from a recent time cutoff.'))),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030*Return the results with bbcode formatting.'))),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030iCombined with start time, only messages after this ordinal are returned (dedupes messages in same second)'))),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\0306if present/non-zero, return only messages before this.'))),
    _descriptor.FieldDescriptor(
...
_CFRIENDMESSAGES_GETRECENTMESSAGES_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030-Array of messages, returned newest to oldest.'))),
    _descriptor.FieldDescriptor(
...
_CFRIENDSMESSAGES_GETACTIVEMESSAGESESSIONS_REQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030`return only session information where a chat message has been sent since this time (for polling)'))),
  ],
  extensions=[
  ],
  nested_types=[],
...
_CFRIENDSMESSAGES_GETACTIVEMESSAGESESSIONS_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030RThis should be passed in the next request as lastmessage_since to poll for updates'))),
  ],
  extensions=[
  ],
...
_CFRIENDMESSAGES_GETRECENTMESSAGES_REQUEST.fields_by_name['count'].has_options = True
_CFRIENDMESSAGES_GETRECENTMESSAGES_REQUEST.fields_by_name['count']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\0309If non-zero, cap the number of recent messages to return.'))
_CFRIENDMESSAGES_GETRECENTMESSAGES_REQUEST.fields_by_name['most_recent_conversation'].has_options = True
_CFRIENDMESSAGES_GETRECENTMESSAGES_REQUEST.fields_by_name['most_recent_conversation']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030MGrab the block of chat from the most recent conversation (a ~5 minute period)'))
_CFRIENDMESSAGES_GETRECENTMESSAGES_REQUEST.fields_by_name['rtime32_start_time'].has_options = True
_CFRIENDMESSAGES_GETRECENTMESSAGES_REQUEST.fields_by_name['rtime32_start_time']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030\207\001If non-zero, return only messages with timestamps greater or equal to this. If zero, we only return messages from a recent time cutoff.'))
_CFRIENDMESSAGES_GETRECENTMESSAGES_REQUEST.fields_by_name['bbcode_format'].has_options = True
_CFRIENDMESSAGES_GETRECENTMESSAGES_REQUEST.fields_by_name['bbcode_format']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030*Return the results with bbcode formatting.'))
_CFRIENDMESSAGES_GETRECENTMESSAGES_REQUEST.fields_by_name['start_ordinal'].has_options = True
_CFRIENDMESSAGES_GETRECENTMESSAGES_REQUEST.fields_by_name['start_ordinal']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030iCombined with start time, only messages after this ordinal are returned (dedupes messages in same second)'))
_CFRIENDMESSAGES_GETRECENTMESSAGES_REQUEST.fields_by_name['time_last'].has_options = True
_CFRIENDMESSAGES_GETRECENTMESSAGES_REQUEST.fields_by_name['time_last']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\0306if present/non-zero, return only messages before this.'))
_CFRIENDMESSAGES_GETRECENTMESSAGES_RESPONSE.fields_by_name['messages'].has_options = True
_CFRIENDMESSAGES_GETRECENTMESSAGES_RESPONSE.fields_by_name['messages']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030-Array of messages, returned newest to oldest.'))
_CFRIENDSMESSAGES_GETACTIVEMESSAGESESSIONS_REQUEST.fields_by_name['lastmessage_since'].has_options = True
_CFRIENDSMESSAGES_GETACTIVEMESSAGESESSIONS_REQUEST.fields_by_name['lastmessage_since']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030`return only session information where a chat message has been sent since this time (for polling)'))
_CFRIENDSMESSAGES_GETACTIVEMESSAGESESSIONS_RESPONSE.fields_by_name['timestamp'].has_options = True
_CFRIENDSMESSAGES_GETACTIVEMESSAGESESSIONS_RESPONSE.fields_by_name['timestamp']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030RThis should be passed in the next request as lastmessage_since to poll for updates'))
...
_FRIENDMESSAGES = _descriptor.ServiceDescriptor(
  ...
  file=DESCRIPTOR,
  index=0,
  options=_descriptor._ParseOptions(descriptor_pb2.ServiceOptions(), _b('\202\265\030]A service for relaying and logging friend messages (user-to-user chats and offline messaging)')),
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\0303Get a log of recent chat messages between two users')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\0307Get information about recent offline messages and chats')),
  ),
  _descriptor.MethodDescriptor(
    name='SendMessage',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030\037Send a chat message to a friend')),
  ),
  _descriptor.MethodDescriptor(
    name='AckMessage',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030CAcknowledge that we have seen the most recent message from a friend')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030)See if a friend is in the friendsui beta.')),
  ),
])
...
_FRIENDMESSAGESCLIENT = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=steammessages__unified__base__pb2._NORESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030\037New chat message from a friend.')),
  ),
  _descriptor.MethodDescriptor(
