...
_INVENTORY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=_CINVENTORY_RESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\265\030\024Get item definitions')),
  ),
  _descriptor.MethodDescriptor(
    name='ConsumeItem',
