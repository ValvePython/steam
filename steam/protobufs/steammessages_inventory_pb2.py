...
_CINVENTORY_ADDITEM_REQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), b'\202\265\030HShould notify the user that the item was added to their Steam Inventory.')),
  ],
  extensions=[
  ],
  nested_types=[],
...
_CINVENTORY_ADDITEM_REQUEST.fields_by_name['notify']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), b'\202\265\030HShould notify the user that the item was added to their Steam Inventory.')
